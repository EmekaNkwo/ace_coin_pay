...
function App() {
  ...
  return (
    ...
    >
      <div className="lg:w-[70%] w-[90%] min-h-[70vh] mt-[1rem] lg:mt-0  bg-[#fff] overflow-auto">
        ...
        <div className="lg:my-[2rem] my-[1rem] lg:mx-[5rem] mx-[2rem] flex items-start lg:gap-[3rem] gap-[1rem] ">
